...
class GroupTableViewController: UITableViewController {
    ...
    let groupArray = ["Автолюбители","Гринпис"]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.imageView?.image = UIImage(named: groupArray[indexPath.row])
        //Надо чтобы изображения любых размеров обрезались, почемуто не работает
